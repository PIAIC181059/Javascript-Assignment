...
//Taking input of Person's name
if (personName) {  
    
    //displaying name in required cases if person has entered his name
...
else console.log("Alas! You didn't write your name!"); /

/if person has not entered his name 
Footer
